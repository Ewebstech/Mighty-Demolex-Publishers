...
<div class="page_title" style="background-color: #f00;">
	...
	<div class="container" >
		<div class="title"><h1 style="color: #fff;">About Us</h1></div>
        <div class="pagenation" style="color: #fff;"><a href="index.html">Home</a> <i>/</i> <a href="#">Pages</a> <i>/</i> About Us</div>
	</div>
</div><!-- end page title --> 
...
<div class="container">
    ...
    <div id="progress_bar" class="ui-progress-bar ui-container">
      <div class="ui-progress">
        <span class="ui-label">Timeliness  <b class="value">91%</b></span>
      </div>
    </div><!-- end progress bar -->

    <div id="progress_bar2" class="ui-progress-bar ui-container">
      <div class="ui-progress">
        <span class="ui-label">Design Quality <b class="value">89%</b></span>
      </div>
    </div><!-- end progress bar -->

    <div id="progress_bar3" class="ui-progress-bar ui-container">
      <div class="ui-progress">
        <span class="ui-label">Press Quality <b class="value">85%</b></span>
      </div>
    </div><!-- end progress bar -->

    <div id="progress_bar4" class="ui-progress-bar ui-container">
      <div class="ui-progress">
        <span class="ui-label">Deliverables <b class="value">90%</b></span>
      </div>
    </div><!-- end progress bar -->
